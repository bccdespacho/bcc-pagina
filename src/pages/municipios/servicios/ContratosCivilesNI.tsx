...
const schemaJSON = {
    ...
    description: 'Redacción, revisión y formalización de contratos civiles en Nuevo Ideal: compraventa, arrendamiento, prestación de servicios y préstamos entre particulares.',
    mainEntityOfPage: {
        '@type': 'WebPage',
        '@id': 'https://bccdespachojuridico.com/municipios/nuevo-ideal/servicios/contratos-civiles',
    },
    hasFAQPage: {
        '@type': 'FAQPage',
        mainEntity: [
...
const tiposDeContrato = [
    {
        ...
        detail: 'En BCC redactamos y revisamos contratos de compraventa de bienes muebles e inmuebles en Nuevo Ideal, asegurándonos de que cada cláusula te proteja a ti, no a la otra parte.',
    },
    {
        ...
        detail: 'Conocemos la realidad del mercado inmobiliario local y redactamos contratos que son justos, claros y ejecutables si surge algún conflicto.',
    },
    {
...
const quehaceBCC = [
    'Redactamos contratos desde cero adaptados a tu caso en Nuevo Ideal',
...
const erroresComunes = [
    ...
    },
    {
        ...
        desc: 'Las plantillas genéricas no consideran la legislación local ni las particularidades del caso. Lo que funciona en otro lado puede no ser válido aquí.',
    },
    {
        num: '5',
...
const faqs = [
    ...
    {
        q: '¿Pueden redactar contratos para negocios pequeños en Nuevo Ideal?',
    ...
    {
        q: '¿Atienden contratos relacionados con propiedades en Nuevo Ideal?',
...
// --- Page ---
export default function ContratosCivilesNI() {
    // Inject page-specific Schema JSON-LD and SEO tags
    useEffect(() => {
        document.title = "Abogado para Contratos Civiles en Nuevo Ideal | BCC";

        const metaDesc = document.querySelector('meta[name="description"]');
        if (metaDesc) {
            metaDesc.setAttribute("content", "Asesoría para redacción y revisión de contratos en Nuevo Ideal. Compraventas, arrendamientos y mutuos. Emiliano Zapata 707.");
        }

        const script = document.createElement('script');
        script.type = 'application/ld+json';
        script.id = 'schema-contratos-civiles-ni';
        script.textContent = JSON.stringify(schemaJSON);
        document.head.appendChild(script);

        return () => {
            const existing = document.getElementById('schema-contratos-civiles-ni');
                        ...
                        <div className="max-w-4xl mx-auto">
                            ...
                            >
                                ...
                                <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6 leading-tight">
                                    Contratos Civiles en Nuevo Ideal:{' '}
                                ...
                                <p className="text-lg text-gray-600 leading-relaxed mb-4">
                                    En BCC Asesoría Jurídica e Inmobiliaria ayudamos a personas y pequeños empresarios de Nuevo Ideal
                            ...
                            >
                                ...
                                <p className="text-gray-600 leading-relaxed mb-6">
                                    Mucha gente firma contratos sin leerlos bien, o peor, hace acuerdos
                            ...
                            <div className="mb-16">
                                ...
                                <p className="text-gray-600 mb-10 leading-relaxed">
                                    ...
                                    riesgos si se omite algo importante. Aquí es donde la experiencia profesional marca
                                    la diferencia.
                                </p>
                            ...
                            <div className="mb-12">
                                ...
                                <p className="text-gray-600 mb-8 leading-relaxed">
                                    Después de años atendiendo casos, estos son los problemas más
                            ...
                            >
                                ...
                                <p className="text-gray-600 mb-6 leading-relaxed">
                                    Antes de firmar cualquier contrato, verifica que incluya:
                                </p>
                                <ul className="space-y-3">
                                    {checklist.map((item) => (
                                        <li key={item} className="flex items-start gap-3">
                            ...
                            >
                                <h2 className="text-3xl md:text-4xl font-bold mb-4 text-black">
                                    Agenda tu Consulta con Asesoría Jurídica BCC
                                </h2>
                                <p className="text-white text-lg mb-4 max-w-2xl mx-auto leading-relaxed">
                                    ...
                                    convierte en un problema. No dejes algo tan importante al azar o a plantillas genéricas.
                                </p>
                                <p className="text-white/90 text-base mb-6 max-w-xl mx-auto">
                                    Estamos listos para ayudarte a proteger tus acuerdos en Nuevo Ideal.
                                </p>
